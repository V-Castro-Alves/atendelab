        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=pessoas&action=index">
                            Pessoas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=tipos-atendimentos&action=index">
                            Tipos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=atendimentos&action=index">
                            Atendimentos
                        </a>
                    </li>
                </ul>
